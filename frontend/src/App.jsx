// App.jsx — Dashboard principal do Crypto AI Trader
...
export default function App() {
  const { status, trades, indicators, connected, lastUpdate, resetWallet } = useTrader()

  const wallet    = status?.wallet
  const lastCycle = status?.lastCycle
  const ind       = indicators

  // PnL histórico para mini gráfico (trades com pnl)
    ...
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 16 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {pnlHistory.length > 1 && (
            <div style={{ background: '#111120', border: '1px solid #1e1e2e', borderRadius: 12, padding: 18 }}>
              <h2 style={{ margin: '0 0 14px', fontSize: 13, color: '#555', textTransform: 'uppercase', letterSpacing: 1 }}>
                PnL acumulado
              </h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ background: '#111120', border: '1px solid #1e1e2e', borderRadius: 12, padding: 18 }}>
            <h2 style={{ margin: '0 0 18px', fontSize: 13, color: '#555', textTransform: 'uppercase', letterSpacing: 1 }}>
          ...
          {wallet?.position && (
            <div style={{ background: '#0d2a1a', border: '1px solid #0d4a2a', borderRadius: 12, padding: 18 }}>
              <h2 style={{ margin: '0 0 14px', fontSize: 13, color: '#22c97b', textTransform: 'uppercase', letterSpacing: 1 }}>
                Posição aberta
              </h2>
              {[
